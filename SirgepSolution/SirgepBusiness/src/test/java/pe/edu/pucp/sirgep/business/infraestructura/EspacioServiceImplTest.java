...
public class EspacioServiceImplTest {
    ...
    public void setUp() {
        ...
        this.espacioService = new EspacioServiceImpl();
    }
    ...
    public void testInsertar() {
        ...
        int result = this.espacioService.insertar(this.espacio);
        assertTrue(result != -1);
    }
    ...
    public void testBuscar() {
        ...
        Espacio result = this.espacioService.buscar(2);
    ...
    public void testListar() {
        ...
        List<Espacio> lista = this.espacioService.listar();
        assertNotNull(lista);
    }
    ...
    public void testActualizar() {
        ...
        boolean result = this.espacioService.actualizar(this.espacio);
        assertTrue(result);
    }
    ...
    public void testEliminarLogico() {
        ...
        boolean result = this.espacioService.eliminarLogico(this.espacio.getIdEspacio());
        assertTrue(result);
    }
